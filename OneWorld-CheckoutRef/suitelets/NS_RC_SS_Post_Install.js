function postInstallCombiner ()
{
	...
	try
	{
		...
		,	reference_container_path = "/Web Site Hosting Files/Live Hosting Files/SSP Applications/NetSuite Inc. - Checkout 2.04.0/Reference Checkout"
		...
		context.getSetting('SCRIPT', 'custscript_ns_rc_scast_folders').split(';').forEach(function (path, index)
		{
