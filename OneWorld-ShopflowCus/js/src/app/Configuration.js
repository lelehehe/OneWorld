...
(function (application)
{
	...
	,	macros: {
		...
		,	itemOptions: {
				...
				// for grid options
			,	grid: {
					'default': 'itemDetailsOptionsGrid'
				}
	...
	,	navigationTabs: [
		...
		,	{
			text: _('Privacy & Security').translate()
		,	href: '/privacy-security'
		,	'class': 'tab home-tab'
		,	data: {
				touchpoint: 'home'
			,	hashtag: '#privacy-security'
				}
			}
		]
	...
	,	sortOptions: [
		...
		,	{id: 'cost:asc', name: _('Price, Low to High').translate()}
		,	{id: 'cost:desc', name: _('Price, High to Low ').translate()}
		]
	...
	,	gridOptions: {
			horizontal: []
		,	vertical: []
			// horizontal: ['custcol_rim_color']
		// ,	vertical: ['custcol_matrix_tire_size']
		}
